...
//Note- for the extra credit it seems we need some sort of parser and I think rolling our own would be reinventing the wheel.
//I found a simple parser at the website below and modified it to suit our purposes.
//http://www.speqmath.com/tutorials/expression_parser_java/html/code/Parser.java.html
...
public class Parser
{
   ...
   */
  public double parse(final String new_expr)
  {
   ...
   * evaluate a variable
   */
  double eval_variable(final String var_name) 
  {
