...
public class DAO {
    ...
    public static void createDataIfNonExistent(Context context){
    	...
    	//SaleLine.deleteAll(SaleLine.class);
    ...
    private static void createTestSaleLines(Context context){
        ...
        new SaleLine(context, items.get(1).getPrice(),items.get(0),sales.get(7)).save();
        new SaleLine(context, items.get(1).getPrice(),items.get(4),sales.get(7)).save();
        
        new SaleLine(context, items.get(1).getPrice(),items.get(6),sales.get(8)).save();
        new SaleLine(context, items.get(1).getPrice(),items.get(5),sales.get(8)).save();
